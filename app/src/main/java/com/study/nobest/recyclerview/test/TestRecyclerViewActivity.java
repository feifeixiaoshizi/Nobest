...
public class TestRecyclerViewActivity extends BaseActivity<TestRecyclerViewPresenter> implements TestRecyclerViewContract.View {
       ...
       // linearLayoutManager = new LinearLayoutManager(this);
        ...
        recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                positions = staggeredGridLayoutManager.findLastVisibleItemPositions(positions);
                Log.d(TAG, "childCount:" + childCount+"itemCount:"+itemCount+"positions0:"+positions[0]+"positions1:"+positions[1]);
